...
public struct MobilityboxTicketView: View {
    ...
    public var body: some View {
        HStack(spacing: 0) {
            LeftCardView(title: ticket.getTitle(), details: ticket.getPassengerName(), addedAgoText: ticket.getAddedAgoText(), referenceTag: ticket.getReferenceTag(), environment: ticket.environment) {
